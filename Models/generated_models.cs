...
namespace SimpleModelsAndRelations.Models
{
  ...
  [Table("G1")] public partial class Group1: IEntity {
    ...
    [Newtonsoft.Json.JsonIgnore]
       ...
       public virtual ICollection<Group1_Item1> Group1_Item1S {get;set;}
    [Newtonsoft.Json.JsonProperty(ItemConverterType = typeof(Newtonsoft.Json.Converters.JavaScriptDateTimeConverter))] public DateTime CreatedDate{ get; set; }
  ...
  public partial class Item1: IEntity {
    public Item1() {
      Item1_Group1S = new HashSet<Group1_Item1>();
    }
    public int Id {get;set;}
    [Newtonsoft.Json.JsonIgnore]
       [InverseProperty("Item1")]
       public virtual ICollection<Group1_Item1> Item1_Group1S {get;set;}
    [Newtonsoft.Json.JsonProperty(ItemConverterType = typeof(Newtonsoft.Json.Converters.JavaScriptDateTimeConverter))] public DateTime CreatedDate{ get; set; }
  ...
  public partial class Group2: IEntity {
    ...
    [Newtonsoft.Json.JsonIgnore]
       ...
       public virtual ICollection<Group2_Item2A> Group2_Item2AS {get;set;}
    [Newtonsoft.Json.JsonIgnore]
       [InverseProperty("Group2")]
       public virtual ICollection<Group2_Item2B> Group2_Item2BS {get;set;}
    [Newtonsoft.Json.JsonProperty(ItemConverterType = typeof(Newtonsoft.Json.Converters.JavaScriptDateTimeConverter))] public DateTime CreatedDate{ get; set; }
        public string Name {get;set;}
  ...
  public partial class Item2A: IEntity {
    public Item2A() {
      Item2A_Group2S = new HashSet<Group2_Item2A>();
    }
    public int Id {get;set;}
    [Newtonsoft.Json.JsonIgnore]
       [InverseProperty("Item2A")]
       public virtual ICollection<Group2_Item2A> Item2A_Group2S {get;set;}
    [Newtonsoft.Json.JsonProperty(ItemConverterType = typeof(Newtonsoft.Json.Converters.JavaScriptDateTimeConverter))] public DateTime CreatedDate{ get; set; }
        public string Name {get;set;}
    public string Description {get;set;}
  ...
  public partial class Item2B: IEntity {
    public Item2B() {
      Item2B_Group2S = new HashSet<Group2_Item2B>();
    }
    public int Id {get;set;}
    [Newtonsoft.Json.JsonIgnore]
       [InverseProperty("Item2B")]
       public virtual ICollection<Group2_Item2B> Item2B_Group2S {get;set;}
    [Newtonsoft.Json.JsonProperty(ItemConverterType = typeof(Newtonsoft.Json.Converters.JavaScriptDateTimeConverter))] public DateTime CreatedDate{ get; set; }
        public string Name {get;set;}
    public string Content {get;set;}

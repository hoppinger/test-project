...
[RestrictToUserType(new string[] {"*"})]
    ...
    static public void CleanupNullRelations(SimpleModelsAndRelationsContext _context) {
      ...
      _context.Item1_Group1.RemoveRange(_context.Item1_Group1.Where(l =>
        l.Item1Id == null ||
        l.Group1Id == null ||
        !_context.Item1.Any(s => s.Id == l.Item1Id) ||
        !_context.Group1.Any(s => s.Id == l.Group1Id)));
      ...
      _context.Item2A_Group2.RemoveRange(_context.Item2A_Group2.Where(l =>
        l.Item2AId == null ||
        l.Group2Id == null ||
        !_context.Item2A.Any(s => s.Id == l.Item2AId) ||
        !_context.Group2.Any(s => s.Id == l.Group2Id)));
      ...
      _context.Item2B_Group2.RemoveRange(_context.Item2B_Group2.Where(l =>
        l.Item2BId == null ||
        l.Group2Id == null ||
        !_context.Item2B.Any(s => s.Id == l.Item2BId) ||
        !_context.Group2.Any(s => s.Id == l.Group2Id)));

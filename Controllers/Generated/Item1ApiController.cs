...
using System.IO;
  ...
  [Route("api/v1/Item1")]
  public partial class Item1ApiController : Controller
  {
    ...
    [HttpGet("{Item1_id}/Item1_Group1S")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<Group1> GetItem1_Group1S(int Item1_id, [FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
    ...
    [HttpGet("{Item1_id}/Item1_Group1S/{Group1_id}")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public IActionResult /*Group1*/ GetItem1_Group1ById(int Item1_id, int Group1_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpGet("{Item1_id}/unlinked/Item1_Group1S")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<Group1> GetUnlinkedItem1_Group1S(int Item1_id, [FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
    ...
    bool CanAdd_Item1_Item1_Group1S(Item1 source) {
    ...
    bool CanAdd_Group1_Item1_Group1S(Group1 target) {
      return (from link in _context.Group1_Item1
           where link.Group1Id == target.Id
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpPost("{Item1_id}/Item1_Group1S_Group1")]
    public IActionResult /*IEnumerable<Group1>*/ CreateNewItem1_Group1_Group1(int Item1_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      if (source == null || !can_create_by_token)
        return Unauthorized();
        // throw new Exception("Cannot create item in relation Item1_Group1S");
      var can_link_by_token = ApiTokenValid || true;
      if (!CanAdd_Item1_Item1_Group1S(source) || !can_link_by_token)
        return Unauthorized();
        //throw new Exception("Cannot add item to relation Item1_Group1S");
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpPost("{Item1_id}/Item1_Group1S/{Group1_id}")]
    public IActionResult LinkWithItem1_Group1(int Item1_id, int Group1_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      var can_link_by_token = ApiTokenValid || true;
      if (!CanAdd_Item1_Item1_Group1S(source) || !can_link_by_token || !can_edit_source_by_token || !can_edit_target_by_token)
        return BadRequest();
        // throw new Exception("Cannot add item to relation Item1_Group1S");
      if (!CanAdd_Group1_Item1_Group1S(target))
        return BadRequest();
        // throw new Exception("Cannot add item to relation Item1_Group1S");
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpDelete("{Item1_id}/Item1_Group1S/{Group1_id}")]
    public IActionResult UnlinkFromItem1_Group1(int Item1_id, int Group1_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      if (!can_unlink_by_token || !can_edit_source_by_token || !can_edit_target_by_token) return Unauthorized(); // throw new Exception("Cannot remove item from relation Item1_Group1S");

...
using System.IO;
  ...
  [Route("api/v1/Group1")]
  public partial class Group1ApiController : Controller
  {
    ...
    [HttpGet("{Group1_id}/Group1_HomePages")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<HomePage> GetGroup1_HomePages(int Group1_id, [FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
    ...
    [HttpGet("{Group1_id}/Group1_HomePages/{HomePage_id}")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public IActionResult /*HomePage*/ GetGroup1_HomePageById(int Group1_id, int HomePage_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);

...
using System.IO;
  ...
  [Route("api/v1/Item2A")]
  public partial class Item2AApiController : Controller
  {
    ...
    [HttpGet("{Item2A_id}/Item2A_Group2S")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<Group2> GetItem2A_Group2S(int Item2A_id, [FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
    ...
    [HttpGet("{Item2A_id}/Item2A_Group2S/{Group2_id}")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public IActionResult /*Group2*/ GetItem2A_Group2ById(int Item2A_id, int Group2_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpGet("{Item2A_id}/unlinked/Item2A_Group2S")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<Group2> GetUnlinkedItem2A_Group2S(int Item2A_id, [FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
    ...
    bool CanAdd_Item2A_Item2A_Group2S(Item2A source) {
    ...
    bool CanAdd_Group2_Item2A_Group2S(Group2 target) {
      return true;
    }

    [RestrictToUserType(new string[] {"*"})]
    [HttpPost("{Item2A_id}/Item2A_Group2S_Group2")]
    public IActionResult /*IEnumerable<Group2>*/ CreateNewItem2A_Group2_Group2(int Item2A_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      if (source == null || !can_create_by_token)
        return Unauthorized();
        // throw new Exception("Cannot create item in relation Item2A_Group2S");
      var can_link_by_token = ApiTokenValid || true;
      if (!CanAdd_Item2A_Item2A_Group2S(source) || !can_link_by_token)
        return Unauthorized();
        //throw new Exception("Cannot add item to relation Item2A_Group2S");
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpPost("{Item2A_id}/Item2A_Group2S/{Group2_id}")]
    public IActionResult LinkWithItem2A_Group2(int Item2A_id, int Group2_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      var can_link_by_token = ApiTokenValid || true;
      if (!CanAdd_Item2A_Item2A_Group2S(source) || !can_link_by_token || !can_edit_source_by_token || !can_edit_target_by_token)
        return BadRequest();
        // throw new Exception("Cannot add item to relation Item2A_Group2S");
      if (!CanAdd_Group2_Item2A_Group2S(target))
        return BadRequest();
        // throw new Exception("Cannot add item to relation Item2A_Group2S");
    ...
    [RestrictToUserType(new string[] {"*"})]
    [HttpDelete("{Item2A_id}/Item2A_Group2S/{Group2_id}")]
    public IActionResult UnlinkFromItem2A_Group2(int Item2A_id, int Group2_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);
      ...
      if (!can_unlink_by_token || !can_edit_source_by_token || !can_edit_target_by_token) return Unauthorized(); // throw new Exception("Cannot remove item from relation Item2A_Group2S");

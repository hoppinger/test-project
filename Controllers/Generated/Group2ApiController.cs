...
using System.IO;
  ...
  [Route("api/v1/Group2")]
  public partial class Group2ApiController : Controller
  {
    ...
    [HttpGet("{Group2_id}/Group2_HomePages")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public Page<HomePage> GetGroup2_HomePages(int Group2_id, [FromQuery] int page_index, [FromQuery] int page_size = 25 )
    {
    ...
    [HttpGet("{Group2_id}/Group2_HomePages/{HomePage_id}")]
    [ResponseCache(Location = ResponseCacheLocation.None, NoStore = true)]
    public IActionResult /*HomePage*/ GetGroup2_HomePageById(int Group2_id, int HomePage_id)
    {
      var session = HttpContext.Get<LoggableEntities>(_context);

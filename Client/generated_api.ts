...
export async function get_Group1_Group1_HomePages(source:Models.Group1, page_index:number, page_size:number, query_string:string = null) : Promise<RawPage<Models.HomePage>> {
  let res = await fetch(`/api/v1/Group1/${source.Id}/Group1_HomePages?page_index=${page_index}&page_size=${page_size}${(query_string != null ? "&search_query=" + query_string : "")}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.HomePage>(json, e => { return {...e, }})
}

export async function get_Group1_Group1_HomePages_HomePage(source:Models.Group1, page_index:number, page_size:number, id:number) : Promise<Models.HomePage> {
  let res = await fetch(`/api/v1/Group1/${source.Id}/Group1_HomePages/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.HomePage
}

export async function get_Group1_Group1_HomePages_HomePage_by_id(source:Models.Group1, id:number) : Promise<Models.HomePage> {
  let res = await fetch(`/api/v1/Group1/${source.Id}/Group1_HomePages/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.HomePage
...
export async function get_Item1_Item1_Group1S(source:Models.Item1, page_index:number, page_size:number, query_string:string = null) : Promise<RawPage<Models.Group1>> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S?page_index=${page_index}&page_size=${page_size}${(query_string != null ? "&search_query=" + query_string : "")}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group1>(json, e => { return {...e, Time: Moment.utc(e.Time), Date: Moment.utc(e.Date), DateTime: Moment.utc(e.DateTime)}})
}

export async function get_Item1_Item1_Group1S_Group1(source:Models.Item1, page_index:number, page_size:number, id:number) : Promise<Models.Group1> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate), Time: Moment.utc(json.Time), Date: Moment.utc(json.Date), DateTime: Moment.utc(json.DateTime) } as Models.Group1
}

export async function get_Item1_Item1_Group1S_Group1_by_id(source:Models.Item1, id:number) : Promise<Models.Group1> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate), Time: Moment.utc(json.Time), Date: Moment.utc(json.Date), DateTime: Moment.utc(json.DateTime) } as Models.Group1
...
export async function get_unlinked_Item1_Item1_Group1S(source:Models.Item1, page_index:number, page_size:number) : Promise<RawPage<Models.Group1>> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/unlinked/Item1_Group1S?page_index=${page_index}&page_size=${page_size}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group1>(json, e => { return {...e, Time: Moment.utc(e.Time), Date: Moment.utc(e.Date), DateTime: Moment.utc(e.DateTime)}})
}
...
export async function create_linked_Item1_Item1_Group1S_Group1(source:Models.Item1) : Promise<Models.Group1[]> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S_Group1`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
...
export async function link_Item1_Item1_Group1S(source:Models.Item1, target:Models.Group1) : Promise<void> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S/${target.Id}`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}

export async function unlink_Item1_Item1_Group1S(source:Models.Item1, target:Models.Group1) : Promise<void> {
  let res = await fetch(`/api/v1/Item1/${source.Id}/Item1_Group1S/${target.Id}`, { method: 'delete', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}
...
export async function get_Group2_Group2_HomePages(source:Models.Group2, page_index:number, page_size:number, query_string:string = null) : Promise<RawPage<Models.HomePage>> {
  let res = await fetch(`/api/v1/Group2/${source.Id}/Group2_HomePages?page_index=${page_index}&page_size=${page_size}${(query_string != null ? "&search_query=" + query_string : "")}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.HomePage>(json, e => { return {...e, }})
}

export async function get_Group2_Group2_HomePages_HomePage(source:Models.Group2, page_index:number, page_size:number, id:number) : Promise<Models.HomePage> {
  let res = await fetch(`/api/v1/Group2/${source.Id}/Group2_HomePages/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.HomePage
}

export async function get_Group2_Group2_HomePages_HomePage_by_id(source:Models.Group2, id:number) : Promise<Models.HomePage> {
  let res = await fetch(`/api/v1/Group2/${source.Id}/Group2_HomePages/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.HomePage
...
export async function get_Item2A_Item2A_Group2S(source:Models.Item2A, page_index:number, page_size:number, query_string:string = null) : Promise<RawPage<Models.Group2>> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S?page_index=${page_index}&page_size=${page_size}${(query_string != null ? "&search_query=" + query_string : "")}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group2>(json, e => { return {...e, }})
}

export async function get_Item2A_Item2A_Group2S_Group2(source:Models.Item2A, page_index:number, page_size:number, id:number) : Promise<Models.Group2> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.Group2
}

export async function get_Item2A_Item2A_Group2S_Group2_by_id(source:Models.Item2A, id:number) : Promise<Models.Group2> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.Group2
...
export async function get_unlinked_Item2A_Item2A_Group2S(source:Models.Item2A, page_index:number, page_size:number) : Promise<RawPage<Models.Group2>> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/unlinked/Item2A_Group2S?page_index=${page_index}&page_size=${page_size}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group2>(json, e => { return {...e, }})
}
...
export async function create_linked_Item2A_Item2A_Group2S_Group2(source:Models.Item2A) : Promise<Models.Group2[]> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S_Group2`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return json.map(e => { return {...e, CreatedDate: Moment.utc(e.CreatedDate),  }}) as Models.Group2[]
}

export async function link_Item2A_Item2A_Group2S(source:Models.Item2A, target:Models.Group2) : Promise<void> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S/${target.Id}`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}

export async function unlink_Item2A_Item2A_Group2S(source:Models.Item2A, target:Models.Group2) : Promise<void> {
  let res = await fetch(`/api/v1/Item2A/${source.Id}/Item2A_Group2S/${target.Id}`, { method: 'delete', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}
...
export async function get_Item2B_Item2B_Group2S(source:Models.Item2B, page_index:number, page_size:number, query_string:string = null) : Promise<RawPage<Models.Group2>> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S?page_index=${page_index}&page_size=${page_size}${(query_string != null ? "&search_query=" + query_string : "")}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group2>(json, e => { return {...e, }})
}

export async function get_Item2B_Item2B_Group2S_Group2(source:Models.Item2B, page_index:number, page_size:number, id:number) : Promise<Models.Group2> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.Group2
}

export async function get_Item2B_Item2B_Group2S_Group2_by_id(source:Models.Item2B, id:number) : Promise<Models.Group2> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S/${id}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return {...json, CreatedDate: Moment.utc(json.CreatedDate),  } as Models.Group2
...
export async function get_unlinked_Item2B_Item2B_Group2S(source:Models.Item2B, page_index:number, page_size:number) : Promise<RawPage<Models.Group2>> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/unlinked/Item2B_Group2S?page_index=${page_index}&page_size=${page_size}`, { method: 'get', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return make_page<Models.Group2>(json, e => { return {...e, }})
}
...
export async function create_linked_Item2B_Item2B_Group2S_Group2(source:Models.Item2B) : Promise<Models.Group2[]> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S_Group2`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  let json = await res.json()
  return json.map(e => { return {...e, CreatedDate: Moment.utc(e.CreatedDate),  }}) as Models.Group2[]
}

export async function link_Item2B_Item2B_Group2S(source:Models.Item2B, target:Models.Group2) : Promise<void> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S/${target.Id}`, { method: 'post', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}

export async function unlink_Item2B_Item2B_Group2S(source:Models.Item2B, target:Models.Group2) : Promise<void> {
  let res = await fetch(`/api/v1/Item2B/${source.Id}/Item2B_Group2S/${target.Id}`, { method: 'delete', credentials: 'include', headers:{'content-type': 'application/json'} })
  if (!res.ok) throw Error(res.statusText)
  return
}

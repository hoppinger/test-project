...
export function Group2_Group2_HomePage_can_create(self:Group2Context) {
...
export function Group2_Group2_HomePage_can_delete(self:Group2Context) {
  let state = self.state()
...
export function Group2_Group2_HomePage_page_index(self:Group2Context) {
  let state = self.state()
...
export function Group2_Group2_HomePage_page_size(self:Group2Context) {
  let state = self.state()
...
export function Group2_Group2_HomePage_search_query(self:Group2Context) {
  let state = self.state()
...
export function Group2_Group2_HomePage_num_pages(self:Group2Context) {
  let state = self.state()
...
export function load_relation_Group2_Group2_HomePage(self:Group2Context, force_first_page:boolean, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_HomePage() ?
    prelude(() =>
      Api.get_Group2_Group2_HomePages(self.props.entity, Group2_Group2_HomePage_page_index(self), Group2_Group2_HomePage_page_size(self), Group2_Group2_HomePage_search_query(self)).then(HomePages =>
...
export function load_relations_Group2(self, callback?:()=>void) {
  load_relation_Group2_Group2_Item2B(self, false, 
        ...
        () => load_relation_Group2_Group2_HomePage(self, false, 
        () => callback && callback())))
}
...
export function render_Group2_Group2_HomePage(self:Group2Context, context:"presentation_structure"|"default") {
  if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Group2_HomePage") || !Permissions.can_view_HomePage())
    return null
  let state = self.state()
  return <div>
    
    { List.render_relation("group2_group2_homepage",
   "Group2",
   "HomePage",
   "HomePages",
  ...
  (
      state.HomePage != "loading" ?
        ...
        state.HomePage,
      Group2_Group2_HomePage_page_index(self),
      Group2_Group2_HomePage_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.HomePage != "loading" &&
            ...
            <div key={i_id}>
              {
                HomePageViews.HomePage({
                  ...
                  unlink: undefined,
                    delete: !Permissions.can_delete_HomePage() || !Group2_Group2_HomePage_can_delete(self) ?
                    null
                    :

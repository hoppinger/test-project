...
export function Group1_Group1_HomePage_can_create(self:Group1Context) {
...
export function Group1_Group1_HomePage_can_delete(self:Group1Context) {
  let state = self.state()
...
export function Group1_Group1_HomePage_page_index(self:Group1Context) {
  let state = self.state()
...
export function Group1_Group1_HomePage_page_size(self:Group1Context) {
  let state = self.state()
...
export function Group1_Group1_HomePage_search_query(self:Group1Context) {
  let state = self.state()
...
export function Group1_Group1_HomePage_num_pages(self:Group1Context) {
  let state = self.state()
...
export function load_relation_Group1_Group1_HomePage(self:Group1Context, force_first_page:boolean, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_HomePage() ?
    prelude(() =>
      Api.get_Group1_Group1_HomePages(self.props.entity, Group1_Group1_HomePage_page_index(self), Group1_Group1_HomePage_page_size(self), Group1_Group1_HomePage_search_query(self)).then(HomePages =>
...
export function load_relations_Group1(self, callback?:()=>void) {
  load_relation_Group1_Group1_Item1(self, false, 
        () => load_relation_Group1_Group1_HomePage(self, false, 
        () => callback && callback()))
}
...
export function render_Group1_Group1_HomePage(self:Group1Context, context:"presentation_structure"|"default") {
  if ((context == "default" && self.props.shown_relation != "all" && self.props.shown_relation != "Group1_HomePage") || !Permissions.can_view_HomePage())
    return null
  let state = self.state()
  return <div>
    
    { List.render_relation("group1_group1_homepage",
   "Group1",
   "HomePage",
   "HomePages",
  ...
  (
      state.HomePage != "loading" ?
        ...
        state.HomePage,
      Group1_Group1_HomePage_page_index(self),
      Group1_Group1_HomePage_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.HomePage != "loading" &&
          self.setState({...self.state(),
            ...
            <div key={i_id}>
              {
                HomePageViews.HomePage({
                  ...
                  unlink: undefined,
                    delete: !Permissions.can_delete_HomePage() || !Group1_Group1_HomePage_can_delete(self) ?
                    null
                    :
